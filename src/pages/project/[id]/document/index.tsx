...
import { IconCertificate, IconContract, IconReceipt, IconX } from "@tabler/icons-react";
    ...
    return (
        <>
            ...
            <div className="flex flex-col">
                ...
                {/* <Group>
                    <Link href={`/project/${props.id}/document/contract`}>
                        <Button variant="white">สัญญา</Button>
                    </Link>
                    <Button variant="white" disabled>invoice</Button>
                </Group> */}
                <div className="flex gap-5 mt-3">
                    ...
                    {/* <Card withBorder h={200} w={200} className="flex items-center justify-center">
                        <Text fz={"xl"} fw={700}>
                            สัญญา
                        </Text>
                    </Card>

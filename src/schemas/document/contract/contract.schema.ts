...
export const contractSchema = z.object({
  ...
  project_description: z.string({ required_error: "กรุณากรอกรายละเอียดโครงการ" }).min(1, {
  ...
  }).min(1, { message: "กรุณาระบุรายละเอียดงานพิเศษและการแก้ไข เพิ่มเติม เปลี่ยนแปลงงาน" }),
